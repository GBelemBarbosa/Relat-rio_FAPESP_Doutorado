...
\begin{enumerate}
    ...
    Organização dos resultados obtidos, em particular a comparação entre o método proposto (PGCCD) e o estado da arte (L0Learn), bem como a análise das estratégias híbridas com métodos espectrais (NSPG), visando a submissão de um artigo para um periódico de circulação internacional na área de Otimização;
